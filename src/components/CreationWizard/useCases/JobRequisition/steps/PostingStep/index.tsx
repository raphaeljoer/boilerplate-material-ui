...
import { jobReqDataSetPosting } from 'store/slices/CreationWizard/useCases/jobReqCreationWizard/data';
...
export function PostingStep() {
  ...
  const posting = useAppSelector((s) => s.creationWizard.jobReq.data.posting);

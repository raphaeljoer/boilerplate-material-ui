...
export const jobReqDataWizardCreateSlice = createSlice({
...
} = jobReqDataWizardCreateSlice.actions;

export const jobReqDataReducer = jobReqDataWizardCreateSlice.reducer;
